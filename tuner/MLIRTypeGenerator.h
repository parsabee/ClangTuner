...
// The code below is taken from llvm-project/mlir/lib/Target/LLVMIR/ConvertFromLLVMIR.cpp,
...
/// This class generates an mlir type corresponding to types declared in the program.
/// It uses the CodeGenModule to lower types to LLVM types, then uses the above class to
/// lift them to mlir. Arrays are handled differently, Memref dialect is used to represent
/// array types.
