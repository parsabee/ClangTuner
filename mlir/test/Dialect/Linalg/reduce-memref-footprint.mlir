...
// REDUCE-1mb-DAG: [[C0:%.*]] = constant 0 : index
// REDUCE-1mb-DAG: [[C128:%.*]] = constant 128 : index
// REDUCE-1mb-DAG: [[C64:%.*]] = constant 64 : index
// REDUCE-1mb-DAG: [[C1:%.*]] = constant 1 : index
...
// REDUCE-10kb-DAG: [[C0:%.*]] = constant 0 : index
...
func @function_bcast(%arg0: memref<64x128x1024xf32>, %arg1: memref<128x1024xf32>, %arg2: memref<64x128x1024xf32>) {
...
// REDUCE-5mb-LABEL: func @function_bcast(
// REDUCE-5mb-SAME:    [[LHS:%.*]]: {{.*}}, [[RHS:%.*]]: {{.*}}, [[SUM:%.*]]: {{.*}}) {
// REDUCE-5mb-DAG: [[C0:%.*]] = constant 0 : index
// REDUCE-5mb-DAG: [[C64:%.*]] = constant 64 : index
// REDUCE-5mb-DAG: [[C4:%.*]] = constant 4 : index
